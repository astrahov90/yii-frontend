...
class SiteController extends Controller
{
    ...
    public function actionSignup()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->signup()) {
            Yii::$app->session->setFlash('success', 'Благодарим за регистрацию. Проверьте вашу электронную почту.');
            return $this->goHome();
        }
    ...
    public function actionVerifyEmail($token)
    {
        ...
        if (($user = $model->verifyEmail()) && Yii::$app->user->login($user)) {
            Yii::$app->session->setFlash('success', 'Элекронная почта успешно подтверждена!');
            return $this->goHome();
        }

        Yii::$app->session->setFlash('error', 'Ошибка подтверждения электронной почты.');
        return $this->goHome();
    }
    ...
    public function actionPostComments($post_id)
    {
